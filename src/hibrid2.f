...
c JK commented out           call mxma (amat, 1, nmax, bmat, 1, nmax, w, 1, nmax,
c JK commented out     :                nch, nch, nch)
c JK mxma call replaced with dgemm
           call dgemm('n','n',nch,nch,nch,1.0d0,amat,nmax,bmat,nmax, 
     .                0.d0,w,nmax)
...
c JK commented out   call mxma(q,nch,1,w,1,nmax,bmat,nch,1,nphoto,nch,nch)
c JK replaced with dgemm call
           call dgemm('t','n',nphoto,nch,nch,1.0d0,
     .                q,nch,w,nmax,0.d0,bmat,nch)
