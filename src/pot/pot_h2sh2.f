c     pot routine for the interaction of H2S with H2
...
c     current revision:  11-jul-2019 (p. dagdigian)
c     ------------------------------------------------------------------
...
c
     ...
     $  xmconv=0.0005485799094979479d0, sq4pi=3.544907701811032d0)
      end module mod_h2sh2
c     ----------------------------------------------------------------- 
c     loapot subroutine loads pot parameters for H2S-H2 interaction
c     ----------------------------------------------------------------- 
...
C     the time.
      ...
      pot_name = 'H2S-H2 10-6-th1 CCSD(T) PES'
